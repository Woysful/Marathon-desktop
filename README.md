...
First, you’ll need to calculate the desktop grid size. To do this, subtract the height of panels from your display height and then divide this by amount of item you can stack in one column. This way, I can build a grid and determine the size of each cell. In my case, it’s 99x96 pixels.
